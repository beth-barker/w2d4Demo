...
const placesThatStartWithA = places.filter((place) => place[0] === 'A' || place[0] === 'a')
...
const remaining  = expenses.reduce((acc, current) =>  acc - current.amount, budget)
